...
[source, c#]
----
public static IEnumerate<T> Transform(this IEnumerable<T> collection, Func<T, T> transformer);
----
...
[source, c#]
----
public static IEnumerate<T> Filter(this IEnumerable<T> collection, Predicate<int> predicate);
----
...
[source, c#]
----
public static T Reduce(this IEnumerable<T>, Func<T, T, T> func);
----
...
[source, c#]
----
public static IEnumerate<T> Unique(this IEnumerable<T> collection);
----
...
[source, c#]
----
public static IEnumerate<T> Unique2(this IEnumerable<T> collection);
----
...
[source, c#]
----
public static IEnumerate<T> XOR(this IEnumerable<T> thisCollection, IEnumerable<T> other);
----
