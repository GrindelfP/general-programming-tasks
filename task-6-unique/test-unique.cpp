...
int main() {
    ...
    gunique::unique(vec.begin(), vec.end(), std::back_inserter(uniqueVec)); // Use back_inserter
    ...
    gunique::unique(list.begin(), list.end(), std::back_inserter(uniqueList));
    ...
    gunique::unique(vecNoDup.begin(), vecNoDup.end(), std::back_inserter(uniqueVecNoDup));
    ...
    gunique::unique(emptyVec.begin(), emptyVec.end(), std::back_inserter(uniqueEmptyVec));
    ...
    gunique::unique(sameVec.begin(), sameVec.end(), std::back_inserter(uniqueSameVec));
    ...
    gunique::unique(duplicateStartEndVec.begin(), duplicateStartEndVec.end(), std::back_inserter(uniqueDuplicateStartEndVec));
