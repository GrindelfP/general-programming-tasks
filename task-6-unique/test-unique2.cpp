...
int main() {
    ...
    gunique::unique2(list.begin(), list.end(), std::back_inserter(uniqueList));
    ...
    gunique::unique2(vecNoDup.begin(), vecNoDup.end(), std::back_inserter(uniqueVecNoDup));
    ...
    gunique::unique2(emptyVec.begin(), emptyVec.end(), std::back_inserter(uniqueEmptyVec));
    ...
    gunique::unique2(sameVec.begin(), sameVec.end(), std::back_inserter(uniqueSameVec));
    ...
    gunique::unique2(duplicateStartEndVec.begin(), duplicateStartEndVec.end(), std::back_inserter(uniqueDuplicateStartEndVec));
